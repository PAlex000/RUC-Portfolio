  ...
  <>
    <Container fluid style={secondContainer}>
      <Row className="p-2 justify-content-center">
        <h1 className="my-5 px-4 text-center" style={{ color: "#000" }}>
          Recently searched
        </h1>
        {movieData.map((movie) => (
    ...
    <Row className="py-3">
      <Col className="my-4 text-center">
        <Button
          variant="danger"
          style={{ fontSize: "23px", fontWeight: "bold", padding: "1rem" }}
          onClick={handleShow}
        >
        ...
        >
          ...
          <Modal.Body>
            Are you sure you want to delete the whole history? You cannot undo
            this action.
          </Modal.Body>
          <Modal.Footer>
            <Button
