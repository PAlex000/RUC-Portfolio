        ...
        {Array.from({ length: 1 }).map((_, idx) => (
          <Col key={idx}>
            <Card style={cardMovies} className="h-100">
              ...
              <Card.Body>
                <Card.Title as="h4" className="my-2">
                  {title}
                </Card.Title>
                <div className="d-flex flex-row">
                  <TiStarFullOutline size={23} className="mt-1" />{" "}
                  <p style={stars}>
                    {" "}
                    0.00{" "}
                    <span style={review} className="mt-1">
                      (0 reviews)
                    </span>
                  </p>
                </div>
                ...
                >
                  ...
                  <Modal.Body>
                    Are you sure you want to delete this record? You cannot undo
                    this action.
                  </Modal.Body>
                  <Modal.Footer>
                    <Button
